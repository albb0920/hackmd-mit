...
function newNote (req, res, next) {
  ...
  models.Note.create({
    ...
    return res.redirect(config.serverurl + '/' + LZString.compressToEncodedURIComponent(note.id))
  }).catch(function (err) {
    logger.error(err)
...
function showNote (req, res, next) {
  findNote(req, res, function (note) {
    ...
    var noteId = req.params.noteId
    var id = LZString.compressToEncodedURIComponent(note.id)
...
function actionGist (req, res, note) {
  var data = {
    ...
    redirect_uri: config.serverurl + '/auth/github/callback/' + LZString.compressToEncodedURIComponent(note.id) + '/gist',
    scope: 'gist',
...
function publishNoteActions (req, res, next) {
  findNote(req, res, function (note) {
    ...
    switch (action) {
      case 'edit':
        res.redirect(config.serverurl + '/' + (note.alias ? note.alias : LZString.compressToEncodedURIComponent(note.id)))
        break
      default:
